...
const mockleagues = [
  {
    ...
    name: 'Novice League',
    description: 'This is a NOVICE league, there are no requirements to join.',
    verified: true,
    hidden: false,
  ...
  },
  {
    ...
    trophy: 'https://pepiti.com/img/league/trophy/default.png',
    name: 'Amateur League',
    description: 'This is a AMATEUR league, you must have medium MMR and SR to join.',
    verified: true,
    hidden: false,
  ...
  },
  {
    ...
    trophy: 'https://pepiti.com/img/league/trophy/default.png',
    name: 'Pro League',
    description: 'This is a PRO league, you must have high MMR and SR to join.',
    verified: true,
    hidden: false,
    keep_bike_selection: true,
    keep_race_number: true,
  ...
  },
  {
    ...
    name: 'Tookys League',
    description:
      'This is a user created league, there are minimal requirements to join, we just want to have fun.',
    verified: false,
    hidden: false,
    keep_bike_selection: false,
    keep_race_number: true,
